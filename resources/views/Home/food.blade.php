            ...
            <div class="owl-menu-item owl-carousel">
                ...
                @foreach($food as $row)
                    <form action="{{url('/addcart',$row->id)}}" method="post">
                        ...
                        <div class="item">
                            <div style="background-image: url('/image/{{$row->image}}');" class='card '>
                            ...
                            <button style="background-color:#FB5849;width:100%" type="submit" class="btn btn-primary">Add to Cart</button>
                        </div>
                    </form>
                @endforeach

        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="phone">
                                ...
                                <h4>Phone Numbers</h4>
                                <span><a href="#">+92-0309-9553122</a><br><a href="#">+92-0340-63133639</a></span>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="message">
                                ...
                                <h4>Emails</h4>
                                <span><a href="#">qqasimjaved@gmail.com</a><br><a href="#">qqasimjaved@outlook.com</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="contact-form">
                    <form id="contact" action="{{ url('addreservationhome') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
